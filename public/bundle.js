...
/***/ function(module, exports, __webpack_require__) {
	...
	var createHashHistory = __webpack_require__(232);
	...
	var initialStage = _require3.initialStage;

	var _require4 = __webpack_require__(246);
	...
	var StageViewer = React.createClass({
	  ...
	  onImageLoaded: function onImageLoaded() {
	    ...
	    var naturalWidth = _image.naturalWidth;
	    var naturalHeight = _image.naturalHeight;
	  ...
	  onClickCursor: function onClickCursor(projectId) {
	    this.setState({ projectTooltip: null });
	    this.props.onProjectSelect(projectId);
	  },
	  onMouseEnter: function onMouseEnter(project) {
	  ...
	  getImageSize: function getImageSize() {
	    ...
	    var imageWidth = (height - 15 / 100 * height) * imgRatio;
	    var imageHeight = height - 15 / 100 * height;
	    return {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      children ? React.createElement("div", { className: "project-white-overlay" }) : null,
	      React.createElement(
	        ReactCSSTransitionGroup,
	        {
	          component: "div",
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var nextStage = findSiblingStage(stageId, +1);

	    var backgroundElement = React.createElement(
	      "div",
	      { className: "stage-background", key: stageId },
	      React.createElement("img", { src: stageId + "/background_blur.jpg" })
	    );
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement("img", { src: "images/top_arrow.png" })
	      )
	    );
	  }
	});
	...
	var routes = React.createElement(
	  ...
	  React.createElement(
	    Route,
	    { path: ":stageId", component: StageViewer },
	    React.createElement(Route, { path: ":projectId", component: ProjectViewer })
	  ),
	  React.createElement(Route, { path: "/about" }),
	  React.createElement(Route, { path: "/contact" }),
	  React.createElement(IndexRedirect, { from: "/", to: "/" + initialStage })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "e1c244acec3aad88dffff5a5e730d55d.ttf";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findIndex = __webpack_require__(296);
	...
	var ProjectViewer = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var _findSiblingProject = findSiblingProject(stageId, projectId, -1);

	    var prevProjectStageId = _findSiblingProject.stageId;
	    var prevProject = _findSiblingProject.project;

	    var _findSiblingProject2 = findSiblingProject(stageId, projectId, +1);

	    var nextProjectStageId = _findSiblingProject2.stageId;
	    var nextProject = _findSiblingProject2.project;
	    ...
	    return React.createElement(
	      ...
	      React.createElement("div", { className: "project-background" }),
	      React.createElement(
	        "section",
	        ...
	        React.createElement(
	          ...
	          prevProject ? React.createElement(
	            ...
	            React.createElement("img", { src: "images/prev_project.png" })
	          ) : null,
	          React.createElement("img", {
	          ...
	          nextProject ? React.createElement(
	            ...
	            React.createElement("img", { src: "images/next_project.png" })
	          ) : null
	        ),
	        React.createElement(
	          Link,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var find = __webpack_require__(247);
	var findIndex = __webpack_require__(296);
	var assets = __webpack_require__(298);
	...
	function findProject(stageId, projectId) {
	  var stage = findStage(stageId);
	  if (stage) {
	    return find(stage.projects, function (proj) {
	...
	function findSiblingProject(stageId, projectId, inc) {
	  ...
	  var projectIndex = findIndex(projects, function (p) {
	    return p.projectId === projectId;
	  }) + inc;
	  if (projectIndex >= 0 && projectIndex < projects.length) {
	    return { stageId: stageId, project: projects[projectIndex] };
	  }

	  var newStage = findSiblingStage(stageId, inc);
	  ...
	  return { stageId: newStage.stageId, project: project };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseEach = __webpack_require__(248),
	    createFind = __webpack_require__(269);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCallback = __webpack_require__(270),
	    baseFind = __webpack_require__(294),
	    baseFindIndex = __webpack_require__(295),
	    isArray = __webpack_require__(265);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseMatches = __webpack_require__(271),
	    ...
	    bindCallback = __webpack_require__(290),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseGet = __webpack_require__(284),
	    ...
	    toObject = __webpack_require__(252),
	    toPath = __webpack_require__(288);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFindIndex = __webpack_require__(297);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  stages: [__webpack_require__(299), __webpack_require__(300), __webpack_require__(301), __webpack_require__(302)]
	};
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  projects: [{
	    ...
	    images: [{ src: "projet2/01.jpg", alt: "" }, { src: "projet2/02.jpg", alt: "" }, { src: "projet2/03.jpg", alt: "" }, { src: "projet2/04.jpg", alt: "" }, { src: "projet2/05.jpg", alt: "" }, { src: "projet2/06.jpg", alt: "" }, { src: "projet2/07.jpg", alt: "" }, { src: "projet2/08.jpg", alt: "" }, { src: "projet2/09.jpg", alt: "" }],
	    title: "Livret",
	    subtitle: "Défi Innover Ensemble",
	    date: "07 • 2014",
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  projects: [{
	    ...
	    images: [{ src: "projet1/01.jpg", alt: "" }, { src: "projet1/02.jpg", alt: "" }, { src: "projet1/03.jpg", alt: "" }, { src: "projet1/04.jpg", alt: "" }],
	    title: "Convenances",
	    ...
	    images: [{ src: "projet2/01.jpg", alt: "" }, { src: "projet2/02.jpg", alt: "" }, { src: "projet2/03.jpg", alt: "" }, { src: "projet2/04.jpg", alt: "" }, { src: "projet2/05.jpg", alt: "" }, { src: "projet2/06.jpg", alt: "" }],
	    title: "Convenances",
	    subtitle: "Livret",
	    date: "02 • 2014",
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  projects: [{
	    ...
	    images: [{ src: "projet3/01.jpg", alt: "" }, { src: "projet3/02.jpg", alt: "" }, { src: "projet3/03.jpg", alt: "" }, { src: "projet3/04.jpg", alt: "" }, { src: "projet3/05.jpg", alt: "" }],
